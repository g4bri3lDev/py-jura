"""Machine definition for JURA GIGA X8 (NAA) - EF565UL."""
...
ARTICLE_NUMBERS: tuple[int, ...] = (15392,)
...
PRODUCTS: dict[Product, ProductDefinition] = {
    ...
    Product.MILK_COFFEE: ProductDefinition(
        ...
        milk=RangeOption(arg=5, min=1, max=45, step=1, default=10),
    ),
    ...
    Product.CORTADO: ProductDefinition(
        ...
        milk=RangeOption(arg=5, min=1, max=45, step=1, default=3),
    ),
