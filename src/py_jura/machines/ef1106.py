"""Machine definition for JURA Z10 (EB) - EF1106."""
...
PRODUCTS: dict[Product, ProductDefinition] = {
    ...
    Product.LONG_BLACK: ProductDefinition(
        product=Product.LONG_BLACK,
        name="Long Black",
        strength=StrengthOption(
            arg=3,
            values=(
    ...
    Product.MOCACCINO: ProductDefinition(
        product=Product.MOCACCINO,
        name="Mocaccino",
        strength=StrengthOption(
            arg=3,
            values=(
    ...
    Product.CHOCOLATE_MILK_FOAM: ProductDefinition(
        product=Product.CHOCOLATE_MILK_FOAM,
        name="Chocolate Milkfoam",
        milk=RangeOption(arg=5, min=0, max=45, step=1, default=6),
    ),
