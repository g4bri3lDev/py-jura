"""Machine definition for JURA GIGA W10 (SA) - EF1097."""
...
PRODUCTS: dict[Product, ProductDefinition] = {
    ...
    Product.CAPPUCCINO: ProductDefinition(
        ...
        milk=RangeOption(arg=5, min=0, max=120, step=1, default=0),
    ),
    Product.MILK_COFFEE: ProductDefinition(
        ...
        milk=RangeOption(arg=5, min=0, max=45, step=1, default=7),
    ),
    Product.ESPRESSO_MACCHIATO: ProductDefinition(
        ...
        milk=RangeOption(arg=5, min=0, max=45, step=1, default=0),
    ),
    Product.LATTE_MACCHIATO: ProductDefinition(
        ...
        milk=RangeOption(arg=5, min=0, max=45, step=1, default=4),
        milk_break=RangeOption(arg=11, min=0, max=30, step=1, default=10),
    ),
    ...
    Product.MILK_PORTION: ProductDefinition(
        ...
        name="Milk",
        milk=RangeOption(arg=5, min=0, max=45, step=1, default=20),
    ),
    ...
    Product.CORTADO: ProductDefinition(
        ...
        milk=RangeOption(arg=5, min=0, max=45, step=1, default=2),
    ),
    ...
    Product.FLAT_WHITE: ProductDefinition(
        ...
        milk=RangeOption(arg=5, min=0, max=45, step=1, default=14),
    ),
