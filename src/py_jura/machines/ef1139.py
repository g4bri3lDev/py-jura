"""Machine definition for JURA J10 twin (NAA) - EF1139."""
...
PRODUCTS: dict[Product, ProductDefinition] = {
    ...
    Product.MILK_COFFEE: ProductDefinition(
        ...
        milk=RangeOption(arg=5, min=1, max=45, step=1, default=11),
    ),
...
ALERTS: dict[int, Alert] = {
    ...
    56: Alert(bit=56, key="coffee_eye_cup_detected", blocking=False),
}
