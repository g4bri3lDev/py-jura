"""Machine definition for JURA GIGA X8c Professional - EF658S_c."""
...
ARTICLE_NAMES: dict[int, str] = {
    13724: "GIGA X8c Professional",
    13744: "GIGA X8c Professional",
    13745: "GIGA X8c Professional",
    15037: "GIGA X8c Professional JP",
    15087: "GIGA X8c Professional Speed",
    15112: "GIGA X8G Professional",
}
...
PRODUCTS: dict[Product, ProductDefinition] = {
    ...
    Product.CAPPUCCINO: ProductDefinition(
        ...
        milk_break=RangeOption(arg=11, min=0, max=120, step=1, default=0),
    ),
    ...
    Product.FLAT_WHITE: ProductDefinition(
        ...
        milk=RangeOption(arg=5, min=1, max=120, step=1, default=28),
    ),
    Product.XL_LUNGO: ProductDefinition(
        product=Product.XL_LUNGO,
        name="Americano",
        strength=StrengthOption(
            arg=3,
            values=(
    ...
    Product.COFFEE_BIG: ProductDefinition(
        product=Product.COFFEE_BIG,
        name="Coffee Big",
        strength=StrengthOption(
            arg=3,
            values=(
    ...
    Product.CAPPUCCINO_BIG: ProductDefinition(
        product=Product.CAPPUCCINO_BIG,
        name="Cappuccino Big",
        strength=StrengthOption(
            arg=3,
            values=(
    ...
    Product.MILK_COFFEE_BIG: ProductDefinition(
        product=Product.MILK_COFFEE_BIG,
        name="Milkcoffee Big",
        strength=StrengthOption(
            arg=3,
            values=(
    ...
    Product.LATTE_MACCHIATO_BIG: ProductDefinition(
        product=Product.LATTE_MACCHIATO_BIG,
        ...
        milk=RangeOption(arg=5, min=1, max=120, step=1, default=6),
        milk_break=RangeOption(arg=11, min=0, max=120, step=1, default=0),
    ),
    Product.MILK_BIG: ProductDefinition(
        product=Product.MILK_BIG,
        name="Milk Big",
        milk=RangeOption(arg=5, min=1, max=120, step=1, default=40),
    ),
    Product.POT_SPEED: ProductDefinition(
        product=Product.POT_SPEED,
        name="Pot 2 Speed",
        strength=StrengthOption(
            arg=3,
            values=(
    ...
    Product.HOT_WATER_BIG: ProductDefinition(
        product=Product.HOT_WATER_BIG,
        name="Hotwater Portion big",
        water=_water(25, 450, 300),
        temperature=TemperatureOption(
            arg=7,
            options=(
                Temperature.LOW,
...
ALERTS: dict[int, Alert] = {
    ...
    10: Alert(bit=10, key="no_beans", blocking=True),
