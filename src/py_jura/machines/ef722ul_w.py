"""Machine definition for JURA GIGA W3 Professional - EF722UL_W."""
...
ARTICLE_NUMBERS: tuple[int, ...] = (15089,)

ARTICLE_NAMES: dict[int, str] = {
    15089: "GIGA W3 Professional",
}
...
PRODUCTS: dict[Product, ProductDefinition] = {
    ...
    Product.MILK_BIG: ProductDefinition(
        ...
        name="Milk Big",
        milk=RangeOption(arg=5, min=1, max=120, step=1, default=50),
    ),
